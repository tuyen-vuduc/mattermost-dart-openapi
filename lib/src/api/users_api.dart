...
class UsersApi {
  ...
  Future<Response<StatusOK>> attachDeviceId({ 
    required InlineObject15 inlineObject15,
    ...
    final _path = r'/users/sessions/device';
    ...
    try {
      const _type = FullType(InlineObject15);
      _bodyData = _serializers.serialize(inlineObject15, specifiedType: _type);
  ...
  /// * [limit] - The maximum number of users to return in each subresult  __Available as of server version 5.6. Defaults to `100` if not provided or on an earlier server version.__ 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UserAutocomplete] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserAutocomplete>> autocompleteUsers({ 
    ...
    final _path = r'/users/autocomplete';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    UserAutocomplete _responseData;

    try {
      const _responseType = FullType(UserAutocomplete);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UserAutocomplete;
    ...
    return Response<UserAutocomplete>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2002>> checkUserMfa({ 
    required InlineObject11 inlineObject11,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject11, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> convertBotToUser({ 
    required String botUserId,
    required InlineObject107 inlineObject107,
    bool? setSystemAdmin = false,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/bots/{bot_user_id}/convert_to_user'.replaceAll('{' r'bot_user_id' '}', botUserId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (setSystemAdmin != null) r'set_system_admin': encodeQueryParameter(_serializers, setSystemAdmin, const FullType(bool)),
    };

    dynamic _bodyData;

    try {
      const _type = FullType(InlineObject107);
      _bodyData = _serializers.serialize(inlineObject107, specifiedType: _type);
  ...
  Future<Response<StatusOK>> convertUserToBot({ 
    ...
    final _path = r'/users/{user_id}/convert_to_bot'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<User>> createUser({ 
    required InlineObject2 inlineObject2,
    String? t,
    String? iid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (iid != null) r'iid': encodeQueryParameter(_serializers, iid, const FullType(String)),
    };
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject2, specifiedType: _type);
  ...
  Future<Response<UserAccessToken>> createUserAccessToken({ 
    required String userId,
    required InlineObject19 inlineObject19,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/{user_id}/tokens'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject19);
      _bodyData = _serializers.serialize(inlineObject19, specifiedType: _type);
    ...
    try {
      const _responseType = FullType(UserAccessToken);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UserAccessToken;
  ...
  Future<Response<StatusOK>> demoteUserToGuest({ 
    ...
    final _path = r'/users/{user_id}/demote'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<StatusOK>> disableUserAccessToken({ 
    required InlineObject21 inlineObject21,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/tokens/disable';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject21);
      _bodyData = _serializers.serialize(inlineObject21, specifiedType: _type);
  ...
  Future<Response<StatusOK>> enableUserAccessToken({ 
    required InlineObject22 inlineObject22,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/tokens/enable';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject22);
      _bodyData = _serializers.serialize(inlineObject22, specifiedType: _type);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2001>> generateMfaSecret({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{user_id}/mfa/generate'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ChannelMemberWithTeamData>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<ChannelMemberWithTeamData>>> getChannelMembersWithTeamDataForUser({ 
    required String userId,
    int? page,
    int? pageSize,
    CancelToken? cancelToken,
    ...
    final _path = r'/users/{user_id}/channel_members'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ChannelMemberWithTeamData> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(ChannelMemberWithTeamData)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<ChannelMemberWithTeamData>;
    ...
    return Response<BuiltList<ChannelMemberWithTeamData>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> getDefaultProfileImage({ 
    ...
    final _path = r'/users/{user_id}/image/default'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UsersStats>> getKnownUsers({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _responseType = FullType(UsersStats);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UsersStats;
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> getProfileImage({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{user_id}/image'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<Session>>> getSessions({ 
    ...
    final _path = r'/users/{user_id}/sessions'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UsersStats>> getTotalUsersStatsFiltered({ 
    ...
    final _path = r'/users/stats/filtered';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (includeDeleted != null) r'include_deleted': encodeQueryParameter(_serializers, includeDeleted, const FullType(bool)),
      if (includeBots != null) r'include_bots': encodeQueryParameter(_serializers, includeBots, const FullType(bool)),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<UploadSession>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<UploadSession>>> getUploadsForUser({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{user_id}/uploads'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<UploadSession> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(UploadSession)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<UploadSession>;
    ...
    return Response<BuiltList<UploadSession>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<UserAccessTokenSanitized>> getUserAccessToken({ 
    ...
    final _path = r'/users/tokens/{token_id}'.replaceAll('{' r'token_id' '}', tokenId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(UserAccessTokenSanitized);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  Future<Response<BuiltList<UserAccessTokenSanitized>>> getUserAccessTokens({ 
    ...
    try {
      const _responseType = FullType(BuiltList, [FullType(UserAccessTokenSanitized)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<UserAccessTokenSanitized>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<UserAccessTokenSanitized>>> getUserAccessTokensForUser({ 
    required String userId,
    int? page = 0,
    int? perPage = 60,
    CancelToken? cancelToken,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Audit>] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<Audit>>> getUserAudits({ 
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/users/{user_id}/audits'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<Audit> _responseData;

    try {
      const _responseType = FullType(BuiltList, [FullType(Audit)]);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as BuiltList<Audit>;
    ...
    return Response<BuiltList<Audit>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<User>> getUserByEmail({ 
    ...
    final _path = r'/users/email/{email}'.replaceAll('{' r'email' '}', email.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<UserTermsOfService>> getUserTermsOfService({ 
    ...
    final _path = r'/users/{user_id}/terms_of_service'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(UserTermsOfService);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
  ...
  ///
  /// Parameters:
  /// * [requestBody] - List of group channel ids
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse200>> getUsersByGroupChannelIds({ 
    ...
    final _path = r'/users/group_channels';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> loginByCwsToken({ 
  ...
  Future<Response<User>> patchUser({ 
    required String userId,
    required InlineObject5 inlineObject5,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/{user_id}/patch'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject5, specifiedType: _type);
  ...
  Future<Response<StatusOK>> promoteGuestToUser({ 
    ...
    final _path = r'/users/{user_id}/promote'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> publishUserTyping({ 
    required String userId,
    ...
    final _path = r'/users/{user_id}/typing'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject25);
      _bodyData = inlineObject25 == null ? null : _serializers.serialize(inlineObject25, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> registerTermsOfServiceAction({ 
    required String userId,
    required InlineObject24 inlineObject24,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(InlineObject24);
      _bodyData = _serializers.serialize(inlineObject24, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> resetPassword({ 
    required InlineObject9 inlineObject9,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/password/reset';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject9, specifiedType: _type);
  ...
  Future<Response<StatusOK>> revokeAllSessions({ 
    ...
    final _path = r'/users/{user_id}/sessions/revoke/all'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<StatusOK>> revokeSession({ 
    required String userId,
    required InlineObject14 inlineObject14,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/{user_id}/sessions/revoke'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject14, specifiedType: _type);
  ...
  Future<Response<void>> revokeSessionsFromAllUsers({ 
    ...
    final _path = r'/users/sessions/revoke/all';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<StatusOK>> revokeUserAccessToken({ 
    required InlineObject20 inlineObject20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/tokens/revoke';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject20);
      _bodyData = _serializers.serialize(inlineObject20, specifiedType: _type);
  ...
  Future<Response<BuiltList<UserAccessTokenSanitized>>> searchUserAccessTokens({ 
    required InlineObject23 inlineObject23,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/tokens/search';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject23);
      _bodyData = _serializers.serialize(inlineObject23, specifiedType: _type);
  ...
  Future<Response<BuiltList<User>>> searchUsers({ 
    required InlineObject3 inlineObject3,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject3, specifiedType: _type);
  ...
  Future<Response<StatusOK>> sendPasswordResetEmail({ 
    required InlineObject13 inlineObject13,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/password/reset/send';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject13, specifiedType: _type);
  ...
  Future<Response<StatusOK>> sendVerificationEmail({ 
    required InlineObject17 inlineObject17,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/email/verify/send';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject17);
      _bodyData = _serializers.serialize(inlineObject17, specifiedType: _type);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<InlineResponse2003>> switchAccountType({ 
    required InlineObject18 inlineObject18,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/login/switch';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject18);
      _bodyData = _serializers.serialize(inlineObject18, specifiedType: _type);
  ...
  Future<Response<User>> updateUser({ 
    required String userId,
    required InlineObject4 inlineObject4,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject4, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> updateUserActive({ 
    required String userId,
    required InlineObject7 inlineObject7,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/{user_id}/active'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject7, specifiedType: _type);
  ...
  Future<Response<UserAuthData>> updateUserAuth({ 
    ...
    final _path = r'/users/{user_id}/auth'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _responseType = FullType(UserAuthData);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as UserAuthData;
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> updateUserMfa({ 
    required String userId,
    required InlineObject10 inlineObject10,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/{user_id}/mfa'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject10, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> updateUserPassword({ 
    required String userId,
    required InlineObject12 inlineObject12,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject12, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> updateUserRoles({ 
    required String userId,
    required InlineObject6 inlineObject6,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/{user_id}/roles'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(inlineObject6, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> verifyUserEmail({ 
    required InlineObject16 inlineObject16,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/users/email/verify';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InlineObject16);
      _bodyData = _serializers.serialize(inlineObject16, specifiedType: _type);
  ...
  Future<Response<User>> verifyUserEmailWithoutToken({ 
    ...
    final _path = r'/users/{user_id}/email/verify/member'.replaceAll('{' r'user_id' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
