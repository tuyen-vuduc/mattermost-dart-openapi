...
class PermissionsApi {
  ...
  ///
  /// Parameters:
  /// * [subsectionPermissions] - The subsection permissions to return the ancillary permissions for. These values are comma seperated. Ex. subsection_permissions=sysconsole_read_reporting_site_statistics,sysconsole_write_reporting_site_statistics,sysconsole_write_user_management_channels 
  ...
  Future<Response<BuiltList<String>>> getAncillaryPermissions({ 
    ...
    final _path = r'/permissions/ancillary';
    ...
    final _queryParameters = <String, dynamic>{
      if (subsectionPermissions != null) r'subsection_permissions': encodeQueryParameter(_serializers, subsectionPermissions, const FullType(String)),
    };
