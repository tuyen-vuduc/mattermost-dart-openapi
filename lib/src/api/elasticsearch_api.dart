...
class ElasticsearchApi {
  ...
  const ElasticsearchApi(this._dio, this._serializers);
  ...
  Future<Response<StatusOK>> purgeElasticsearchIndexes({ 
    ...
    final _path = r'/elasticsearch/purge_indexes';
  ...
  /// Returns a [Future] containing a [Response] with a [StatusOK] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<StatusOK>> testElasticsearch({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/elasticsearch/test';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
