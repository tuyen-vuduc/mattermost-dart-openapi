...
/// tests for BotsApi
void main() {
  final instance = MattermostDart().getBotsApi();
  ...
  group(BotsApi, () {
    ...
    //
    //Future<Bot> createBot(InlineObject104 inlineObject104) async
    ...
    //
    //Future<BuiltList<Bot>> getBots({ int page, int perPage, bool includeDeleted, bool onlyOrphaned }) async
    ...
    //
    //Future<Bot> patchBot(String botUserId, InlineObject105 inlineObject105) async
