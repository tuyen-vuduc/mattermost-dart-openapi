...
/// tests for TeamsApi
void main() {
  final instance = MattermostDart().getTeamsApi();
  ...
  group(TeamsApi, () {
    ...
    //
    //Future<TeamMember> addTeamMember(String teamId, InlineObject37 inlineObject37) async
    ...
    //
    //Future<BuiltList<TeamMember>> addTeamMembers(String teamId, BuiltList<TeamMember> teamMember, { bool graceful }) async
    ...
    //
    //Future<Team> createTeam(InlineObject32 inlineObject32) async
    ...
    //
    //Future<BuiltList<Team>> getAllTeams({ int page, int perPage, bool includeTotalCount, bool excludePolicyConstrained }) async
    ...
    //
    //Future<InlineResponse2006> getTeamInviteInfo(String inviteId) async
    ...
    //
    //Future<BuiltList<TeamMember>> getTeamMembers(String teamId, { int page, int perPage }) async
    ...
    //
    //Future<BuiltList<TeamMember>> getTeamMembersByIds(String teamId, BuiltList<String> requestBody) async
    ...
    //
    //Future<BuiltList<TeamMember>> getTeamMembersForUser(String userId) async
    ...
    //
    //Future<BuiltList<Team>> getTeamsForUser(String userId) async
    ...
    //
    //Future<BuiltList<TeamUnread>> getTeamsUnreadForUser(String userId, String excludeTeam) async
    ...
    //
    //Future<InlineResponse2005> importTeam(String teamId, MultipartFile file, int filesize, String importFrom) async
    ...
    //
    //Future<StatusOK> inviteGuestsToTeam(String teamId, InlineObject41 inlineObject41) async
    ...
    //
    //Future<StatusOK> inviteUsersToTeam(String teamId, BuiltList<String> requestBody) async
    ...
    //
    //Future<Team> patchTeam(String teamId, InlineObject34 inlineObject34) async
    ...
    //
    //Future<InlineResponse2004> searchTeams(InlineObject36 inlineObject36) async
    ...
    //
    //Future<Team> updateTeam(String teamId, InlineObject33 inlineObject33) async
    ...
    //
    //Future<StatusOK> updateTeamMemberRoles(String teamId, String userId, InlineObject39 inlineObject39) async
    ...
    //
    //Future<StatusOK> updateTeamMemberSchemeRoles(String teamId, String userId, InlineObject40 inlineObject40) async
    ...
    //
    //Future<Team> updateTeamPrivacy(String teamId, InlineObject35 inlineObject35) async
    ...
    //
    //Future<StatusOK> updateTeamScheme(String teamId, InlineObject43 inlineObject43) async
