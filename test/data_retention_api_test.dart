...
void main() {
  final instance = MattermostDart().getDataRetentionApi();

  group(DataRetentionApi, () {
    ...
    //
    //Future<StatusOK> addChannelsToRetentionPolicy(String policyId, BuiltList<String> requestBody) async
    ...
    //
    //Future<StatusOK> addTeamsToRetentionPolicy(String policyId, BuiltList<String> requestBody) async
    ...
    //
    //Future<BuiltList<ChannelWithTeamData>> getChannelsForRetentionPolicy(String policyId, { int page, int perPage }) async
    ...
    //
    //Future<BuiltList<DataRetentionPolicyWithTeamAndChannelCounts>> getDataRetentionPolicies({ int page, int perPage }) async
    ...
    //
    //Future<InlineResponse20016> getDataRetentionPoliciesCount() async
    ...
    //
    //Future<BuiltList<Team>> getTeamsForRetentionPolicy(String policyId, { int page, int perPage }) async
    ...
    //
    //Future<StatusOK> removeChannelsFromRetentionPolicy(String policyId, BuiltList<String> requestBody) async
    ...
    //
    //Future<StatusOK> removeTeamsFromRetentionPolicy(String policyId, BuiltList<String> requestBody) async
    ...
    //
    //Future<BuiltList<ChannelWithTeamData>> searchChannelsForRetentionPolicy(String policyId, InlineObject95 inlineObject95) async
    ...
    //
    //Future<BuiltList<Team>> searchTeamsForRetentionPolicy(String policyId, InlineObject94 inlineObject94) async
