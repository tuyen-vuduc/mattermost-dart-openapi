...
/// tests for CloudApi
void main() {
  final instance = MattermostDart().getCloudApi();
  ...
  group(CloudApi, () {
    ...
    //
    //Future<BuiltList<Product>> getCloudProducts() async
    ...
    //
    //Future<BuiltList<Invoice>> getInvoicesForSubscription() async
    ...
    //
    //Future<CloudCustomer> updateCloudCustomer(InlineObject109 inlineObject109) async
