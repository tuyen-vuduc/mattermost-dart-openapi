# mattermost_dart.model.OutgoingWebhook
...
**triggerWords** | **BuiltList&lt;String&gt;** | List of words for the webhook to trigger on | [optional] 
...
**callbackUrls** | **BuiltList&lt;String&gt;** | The URLs to POST the payloads to when the webhook is triggered | [optional] 
